...
$env:AIRFLOW__LOGGING__BASE_LOG_FOLDER = "$env:AIRFLOW_HOME\.airflow\logs"
...
Write-Host "Logs applicatifs : $env:AIRFLOW_HOME\logs\"
Write-Host "Logs Airflow : $env:AIRFLOW__LOGGING__BASE_LOG_FOLDER\"
